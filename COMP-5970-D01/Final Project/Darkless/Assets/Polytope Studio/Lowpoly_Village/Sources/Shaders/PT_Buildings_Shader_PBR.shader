...
Shader "Polytope Studio/ PT_Medieval Buildings Shader PBR"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _SmoothnessOn;
			float _Exteriorwallstiling;
			float _Metal2metallic;
			float _Metal1metallic;
			float _MetallicOn;
			float _Interiorwallstiling;
						 ...
						 ) : SV_Target
			{
				...
				float4 color315 = IsGammaSpace() ? float4(0.1607843,1,0,1) : float4(0.02217388,1,0,1);
				float2 uv_TextureSample9120 = input.ase_texcoord9.xy;
				float4 MASKTEXTURE251 = tex2D( _TextureSample9, uv_TextureSample9120 );
				float temp_output_310_0 = saturate( ( 1.0 - ( ( distance( color315.rgb , MASKTEXTURE251.rgb ) - 0.1 ) / max( 0.0 , 1E-05 ) ) ) );
				float4 lerpResult309 = lerp( float4( 0,0,0,0 ) , ( BASETEXTURE243 * _Interiorwallscolor ) , temp_output_310_0);
				float4 color314 = IsGammaSpace() ? float4(0.4392157,0,0.4392157,1) : float4(0.1620294,0,0.1620294,1);
				...
				float4 color130 = IsGammaSpace() ? float4(0,0.4784314,0.4784314,1) : float4(0,0.1946179,0.1946179,1);
				...
				float4 color134 = IsGammaSpace() ? float4(0,1,0.7294118,1) : float4(0,1,0.4910209,1);
				float4 lerpResult133 = lerp( lerpResult132 , ( BASETEXTURE243 * _Rock2color ) , saturate( ( 1.0 - ( ( distance( color134.rgb , MASKTEXTURE251.rgb ) - 0.1 ) / max( 0.0 , 1E-05 ) ) ) ));
				float4 color121 = IsGammaSpace() ? float4(0.6196079,0.9333334,1,1) : float4(0.3419145,0.8549928,1,1);
				...
				float4 color138 = IsGammaSpace() ? float4(0.9333334,1,0.6196079,1) : float4(0.8549928,1,0.3419145,1);
				...
				float4 color136 = IsGammaSpace() ? float4(1,0.6196079,0.9333334,1) : float4(1,0.3419145,0.8549928,1);
				...
				float4 color107 = IsGammaSpace() ? float4(1,1,0,1) : float4(1,1,0,1);
				float temp_output_7_0 = saturate( ( 1.0 - ( ( distance( color107.rgb , MASKTEXTURE251.rgb ) - 0.1 ) / max( 0.0 , 1E-05 ) ) ) );
				float4 lerpResult10 = lerp( lerpResult9 , ( BASETEXTURE243 * _Exteriorwalls1colour ) , temp_output_7_0);
				float4 color106 = IsGammaSpace() ? float4(1,0,1,1) : float4(1,0,1,1);
				float temp_output_11_0 = saturate( ( 1.0 - ( ( distance( color106.rgb , MASKTEXTURE251.rgb ) - 0.0 ) / max( 0.0 , 1E-05 ) ) ) );
				float4 lerpResult15 = lerp( lerpResult10 , ( BASETEXTURE243 * _Exteriorwalls2color ) , temp_output_11_0);
				float4 color105 = IsGammaSpace() ? float4(0,1,1,1) : float4(0,1,1,1);
				float temp_output_13_0 = saturate( ( 1.0 - ( ( distance( color105.rgb , MASKTEXTURE251.rgb ) - 0.0 ) / max( 0.0 , 1E-05 ) ) ) );
				float4 lerpResult19 = lerp( lerpResult15 , ( BASETEXTURE243 * _Exteriorwalls3color ) , temp_output_13_0);
				float4 color103 = IsGammaSpace() ? float4(0.6862745,0.8352942,0.8352942,1) : float4(0.4286906,0.6653875,0.6653875,1);
				float4 lerpResult22 = lerp( lerpResult19 , ( BASETEXTURE243 * _Wood1color ) , saturate( ( 1.0 - ( ( distance( color103.rgb , MASKTEXTURE251.rgb ) - 0.1 ) / max( 0.0 , 1E-05 ) ) ) ));
				float4 color104 = IsGammaSpace() ? float4(1,0.7294118,0,1) : float4(1,0.4910209,0,1);
				...
				float4 color102 = IsGammaSpace() ? float4(0.7294118,0,1,1) : float4(0.4910209,0,1,1);
				...
				float4 color17 = IsGammaSpace() ? float4(0.3960785,0.2627451,0.02352941,1) : float4(0.1301365,0.05612849,0.001821162,1);
				...
				float4 color24 = IsGammaSpace() ? float4(0.5372549,0.4313726,0.2509804,1) : float4(0.2501584,0.1559265,0.05126947,1);
				...
				float4 color94 = IsGammaSpace() ? float4(0.7137255,0.6509804,0.5372549,1) : float4(0.4677838,0.3813261,0.2501584,1);
				...
				float4 color84 = IsGammaSpace() ? float4(0,0.1294118,0.5058824,1) : float4(0,0.01520852,0.2195262,1);
				...
				float4 color85 = IsGammaSpace() ? float4(1,0.4313726,0.5254902,1) : float4(1,0.1559265,0.2383977,1);
				...
				float4 color38 = IsGammaSpace() ? float4(0.8274511,0.8784314,0.6980392,1) : float4(0.6514059,0.7454044,0.4452012,1);
				float temp_output_41_0 = saturate( ( 1.0 - ( ( distance( color38.rgb , MASKTEXTURE251.rgb ) - 0.1 ) / max( 0.0 , 1E-05 ) ) ) );
				float4 lerpResult47 = lerp( lerpResult72 , ( BASETEXTURE243 * _Metal1color ) , temp_output_41_0);
				float4 color117 = IsGammaSpace() ? float4(0.6392157,0.6784314,0.5411765,1) : float4(0.3662527,0.4178852,0.2541522,1);
				float temp_output_116_0 = saturate( ( 1.0 - ( ( distance( color117.rgb , MASKTEXTURE251.rgb ) - 0.1 ) / max( 0.0 , 1E-05 ) ) ) );
				float4 lerpResult150 = lerp( lerpResult47 , ( BASETEXTURE243 * _Metal2color ) , temp_output_116_0);
				float4 color118 = IsGammaSpace() ? float4(0.4627451,0.4901961,0.3921569,1) : float4(0.1811642,0.2050788,0.1274377,1);
				float temp_output_149_0 = saturate( ( 1.0 - ( ( distance( color118.rgb , MASKTEXTURE251.rgb ) - 0.1 ) / max( 0.0 , 1E-05 ) ) ) );
				...
				float4 temp_output_1_0_g169 = temp_cast_42;
				float4 color54 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float4 temp_output_2_0_g169 = color54;
				float temp_output_11_0_g169 = distance( temp_output_1_0_g169 , temp_output_2_0_g169 );
				float2 _Vector0 = float2(1.6,1);
				float4 lerpResult21_g169 = lerp( _Coatofarmscolor , temp_output_1_0_g169 , saturate( ( ( temp_output_11_0_g169 - _Vector0.x ) / max( _Vector0.y , 1E-05 ) ) ));
				float temp_output_156_0 = ( 1.0 - temp_output_49_0 );
				float4 lerpResult165 = lerp( lerpResult151 , lerpResult21_g169 , temp_output_156_0);
				float2 temp_cast_43 = (_Interiorwallstiling).xx;
				...
				float4 blendOpSrc325 = INDETAILTEXTUREvar323;
				float4 blendOpDest325 = lerpResult165;
				float INTWALLSMASK329 = temp_output_310_0;
				float4 lerpBlendMode325 = lerp(blendOpDest325,( blendOpSrc325 * blendOpDest325 ),INTWALLSMASK329);
				#ifdef _INTERIORTEXTUREONOFF_ON
				float4 staticSwitch328 = ( saturate( lerpBlendMode325 ));
				#else
				float4 staticSwitch328 = lerpResult165;
				#endif
				float2 temp_cast_45 = ((0.1 + (_Exteriorwallstiling - 0.0) * (0.4 - 0.1) / (1.0 - 0.0))).xx;
				...
				float4 OUTDETAILTEXTUREvar299 = triplanar298;
				float4 blendOpSrc231 = OUTDETAILTEXTUREvar299;
				float4 blendOpDest231 = staticSwitch328;
				float WALLSMASK227 = ( temp_output_7_0 + temp_output_11_0 + temp_output_13_0 );
				float4 lerpBlendMode231 = lerp(blendOpDest231,( blendOpSrc231 * blendOpDest231 ),WALLSMASK227);
				#ifdef _EXTERIORTEXTUREONOFF_ON
				float4 staticSwitch266 = ( saturate( lerpBlendMode231 ));
				#else
				float4 staticSwitch266 = staticSwitch328;
				#endif
				...
				float lerpResult46 = lerp( lerpResult43 , _Metal3smootness , 0.0);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 triplanar322 = TriplanarSampling322( _Interiorwallstexture, _Interiorwallstexture, _Interiorwallstexture, WorldPosition, ase_normalWS, 1.0, temp_cast_43, float3( 1,1,1 ), float3(0,0,0) );
				float4 INDETAILTEXTUREvar323 = triplanar322;
				float4 blendOpSrc325 = INDETAILTEXTUREvar323;
				float4 blendOpDest325 = lerpResult165;
				float INTWALLSMASK329 = temp_output_310_0;
				...
				#endif
				float2 temp_cast_45 = ((0.1 + (_Exteriorwallstiling - 0.0) * (0.4 - 0.1) / (1.0 - 0.0))).xx;
				float4 triplanar298 = TriplanarSampling298( _Exteriorwallstexture, _Exteriorwallstexture, _Exteriorwallstexture, WorldPosition, ase_normalWS, 10.0, temp_cast_45, float3( 1,1,1 ), float3(0,0,0) );
				float4 OUTDETAILTEXTUREvar299 = triplanar298;
				float4 blendOpSrc231 = OUTDETAILTEXTUREvar299;
				float4 blendOpDest231 = staticSwitch328;
				float WALLSMASK227 = ( temp_output_7_0 + temp_output_11_0 + temp_output_13_0 );
...
Node;AmplifyShaderEditor.ColorNode;17;-3840.87,1096.28;Inherit;False;Constant;_Color10;Color 10;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.3960785,0.2627451,0.02352941,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;24;-3178.109,1065.361;Inherit;False;Constant;_Color5;Color 5;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.5372549,0.4313726,0.2509804,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;84;-1213.859,1111.218;Inherit;False;Constant;_Color13;Color 13;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,0.1294118,0.5058824,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;85;-603.5586,1092.531;Inherit;False;Constant;_Color15;Color 15;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;1,0.4313726,0.5254902,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;94;-2579.38,1083.599;Inherit;False;Constant;_Color11;Color 11;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.7137255,0.6509804,0.5372549,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;106;-8111.859,1153.812;Inherit;False;Constant;_Color12;Color 12;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;1,0,1,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;107;-8700.35,1150.605;Inherit;False;Constant;_Color6;Color 6;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;1,1,0,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;117;2001.787,1117.835;Inherit;False;Constant;_Color7;Color 7;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.6392157,0.6784314,0.5411765,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;118;2676.376,1137.907;Inherit;False;Constant;_Color8;Color 7;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.4627451,0.4901961,0.3921569,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;121;-11434.19,1151.006;Inherit;False;Constant;_Color23;Color 23;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.6196079,0.9333334,1,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;136;-10207.81,1113.681;Inherit;False;Constant;_Color25;Color 25;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;1,0.6196079,0.9333334,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;138;-10797.31,1094.721;Inherit;False;Constant;_Color24;Color 24;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.9333334,1,0.6196079,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;102;-5535.17,1135.14;Inherit;False;Constant;_Color32;Color 32;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.7294118,0,1,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;103;-6723.689,1145.791;Inherit;False;Constant;_Color34;Color 34;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.6862745,0.8352942,0.8352942,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;104;-6118.91,1151.033;Inherit;False;Constant;_Color33;Color 33;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;1,0.7294118,0,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;105;-7474.15,1153.183;Inherit;False;Constant;_Color31;Color 31;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,1,1,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;134;-12503.74,1103.401;Inherit;False;Constant;_Color27;Color 24;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,1,0.7294118,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;130;-13129.93,1069.544;Inherit;False;Constant;_Color26;Color 23;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,0.4784314,0.4784314,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;314;-12552.06,2354.387;Inherit;False;Constant;_Color28;Color 24;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.4392157,0,0.4392157,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;315;-13178.25,2320.53;Inherit;False;Constant;_Color29;Color 23;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.1607843,1,0,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;120;-5741.702,-1349.504;Inherit;True;Property;_TextureSample9;Texture Sample 9;42;2;[HideInInspector];[NoScaleOffset];Create;True;0;0;0;False;0;False;120;c91055552562c3941a1c318e8d5bc5c5;c91055552562c3941a1c318e8d5bc5c5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;143;-12424.21,700.1229;Inherit;False;Property;_Rock2color;Rock 2 color;17;1;[HDR];Create;True;0;0;0;False;0;False;0.3679245,0.2968027,0.1787558,0;0.2023368,0,0.4339623,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;332;1068.05,-1383.311;Inherit;False;Property;_Interiorwallstiling;Interior walls tiling;9;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;51;4140.196,-779.3428;Inherit;False;Property;_Coatofarmscolor;Coat of arms color;36;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;1,0.0990566,0.0990566,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;128;-10596.59,675.0156;Inherit;False;Property;_Fabric2color;Fabric 2 color;14;1;[HDR];Create;True;0;0;0;False;0;False;0.3649431,0.5566038,0.4386422,0;0.2023368,0,0.4339623,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;66;-10024.01,673.8386;Inherit;False;Property;_Fabric3color;Fabric 3 color;15;1;[HDR];Create;True;0;0;0;False;0;False;0.5450981,0.6936808,0.6980392,0;0.3773585,0,0.06650025,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;98;-6027.79,655.4275;Inherit;False;Property;_Wood2color;Wood 2 color;11;1;[HDR];Create;True;0;0;0;False;0;False;0.1981132,0.103908,0.06634924,1;0.6792453,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;99;-5511.38,669.605;Inherit;False;Property;_Wood3color;Wood 3 color;12;1;[HDR];Create;True;0;0;0;False;0;False;0.5377358,0.4531547,0.377937,1;0.7735849,0.492613,0.492613,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;89;-3013.319,661.918;Inherit;False;Property;_Ceramictiles2color;Ceramic tiles 2 color;20;1;[HDR];Create;True;0;0;0;False;0;False;0.7924528,0.3776169,0.1682093,1;1,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;90;-2432.66,671.0714;Inherit;False;Property;_Ceramictiles3color;Ceramic tiles 3 color ;22;1;[HDR];Create;True;0;0;0;False;0;False;0.4677838,0.3813261,0.2501584,1;0,0.1142961,0.1698113,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;111;2121.972,708.9114;Inherit;False;Property;_Metal2color;Metal 2 color;27;1;[HDR];Create;True;0;0;0;False;0;False;2,0.5960785,0,0;0.9528302,0.9528302,0.9528302,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;152;2826.721,692.4199;Inherit;False;Property;_Metal3color;Metal 3 color;30;1;[HDR];Create;True;0;0;0;False;0;False;1.584906,0.8017758,0,1;0.3301887,0.3301887,0.3301887,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;38;1330.412,1127.181;Inherit;False;Constant;_Color17;Color 17;51;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.8274511,0.8784314,0.6980392,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;78;1558.641,1655.919;Inherit;False;Property;_Metal1metallic;Metal 1 metallic;25;0;Create;True;0;0;0;False;0;False;0.65;0.903;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;114;2229.969,1639.058;Inherit;False;Property;_Metal2metallic;Metal 2 metallic;28;0;Create;True;0;0;0;False;0;False;0.65;0.903;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;115;2864.037,1633.553;Inherit;False;Property;_Metal3metallic;Metal 3 metallic;31;0;Create;True;0;0;0;False;0;False;0.65;0.903;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;79;1535.77,2263.888;Inherit;False;Property;_Metal1smootness;Metal 1 smootness;26;0;Create;True;0;0;0;False;0;False;0.7;0.721;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;80;2247.969,2207.952;Inherit;False;Property;_Metal2smootness;Metal 2 smootness;29;0;Create;True;0;0;0;False;0;False;0.7;0.721;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;81;2873.24,2206.681;Inherit;False;Property;_Metal3smootness;Metal 3 smootness;32;0;Create;True;0;0;0;False;0;False;0.7;0.7;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;75;-3547.649,2236.753;Inherit;False;Property;_Ceramic1smoothness;Ceramic 1 smoothness;19;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-2915.24,2236.934;Inherit;False;Property;_Ceramic2smoothness;Ceramic 2 smoothness;21;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;77;-2332.96,2231.924;Inherit;False;Property;_Ceramic3smoothness;Ceramic 3 smoothness;23;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;73;-540.9141,659.7532;Inherit;False;Property;_Haycolor;Hay color;34;2;[HDR];[Header];Create;True;0;0;0;False;0;False;0.764151,0.517899,0.1622019,1;0.4245283,0.190437,0.09011215,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;157;3415.809,-925.424;Inherit;True;Property;_Coarofarmstexture;Coar of arms texture;37;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;1;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;100;-7926.76,668.0576;Inherit;False;Property;_Exteriorwalls2color;Exterior walls 2 color;1;1;[HDR];Create;True;0;0;0;False;0;False;0.3524386,0.6133218,0.754717,1;0.6792453,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;68;-7382.76,670.9277;Inherit;False;Property;_Exteriorwalls3color;Exterior walls 3 color;2;1;[HDR];Create;True;0;0;0;False;0;False;0.8867924,0.6561894,0.23843,1;0.7735849,0.492613,0.492613,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TexturePropertyNode;330;896.6069,-1789.026;Inherit;True;Property;_Interiorwallstexture;Interior walls texture;8;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;311;-12469.53,1950.109;Inherit;False;Property;_Mortarcolor;Mortar color;35;1;[HDR];Create;True;0;0;0;False;0;False;0.6415094,0.5745595,0.4629761,0;0.2023368,0,0.4339623,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ToggleSwitchNode;166;7032.947,1537.321;Inherit;True;Property;_MetallicOn;Metallic On;38;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;173;7046.772,2121.252;Inherit;True;Property;_SmoothnessOn;Smoothness On;39;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;88;-3641.46,664.2064;Inherit;False;Property;_Ceramictiles1color;Ceramic tiles 1 color;18;2;[HDR];[Header];Create;True;1;CERAMIC TILES;0;0;False;0;False;0.3207547,0.04869195,0.01059096,1;0.9056604,0.6815338,0.4229263,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;142;-13099.11,707.9922;Inherit;False;Property;_Rock1color;Rock 1 color;16;2;[HDR];[Header];Create;True;1;ROCK ;0;0;False;0;False;0.4127358,0.490063,0.5,0;0,0.1132075,0.01206957,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;307;-13140.54,1954.301;Inherit;False;Property;_Interiorwallscolor;Interior walls color;3;1;[HDR];Create;True;0;0;0;False;0;False;0.4127358,0.490063,0.5,0;0,0.1132075,0.01206957,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;127;-11196.36,713.4846;Inherit;False;Property;_Fabric1color;Fabric 1 color;13;2;[HDR];[Header];Create;True;1;FABRICS;0;0;False;0;False;0.5849056,0.5418971,0.4331613,0;0,0.1132075,0.01206957,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;67;-8518.76,668.0576;Inherit;False;Property;_Exteriorwalls1colour;Exterior walls 1 colour;0;2;[HDR];[Header];Create;True;1;WALLS ;0;0;False;0;False;0.6792453,0.6010633,0.5863296,1;0,0.1793142,0.7264151,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;97;-6631.768,668.1229;Inherit;False;Property;_Wood1color;Wood 1 color;10;2;[HDR];[Header];Create;True;1;WOOD;0;0;False;0;False;0.4056604,0.2683544,0.135858,1;0,0.1793142,0.7264151,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.TexturePropertyNode;296;-1237.267,-1838.107;Inherit;True;Property;_Exteriorwallstexture;Exterior walls texture;5;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;331;-1208.624,-1406.94;Inherit;False;Property;_Exteriorwallstiling;Exterior walls tiling;6;0;Create;True;0;0;0;False;0;False;0;6.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;154;-1158.091,706.2426;Inherit;False;Property;_Ropecolor;Rope color;33;2;[HDR];[Header];Create;True;1;OTHER COLORS;0;0;False;0;False;0.6037736,0.5810711,0.3389106,1;0.1698113,0.04637412,0.02963688,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;74;1444.886,720.598;Inherit;False;Property;_Metal1color;Metal 1 color;24;2;[HDR];[Header];Create;True;1;METAL;0;0;False;0;False;0.385947,0.5532268,0.5566038,0;0.9528302,0.9528302,0.9528302,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.StaticSwitch;328;6279.643,750.4373;Inherit;False;Property;_InteriortextureOnOff;Interior texture On/Off;7;0;Create;True;0;0;0;False;1;Header(INTERIOR WALLS  DETAILS);False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;266;7530.528,712.897;Inherit;False;Property;_ExteriortextureOnOff;Exterior texture On/Off;4;0;Create;True;0;0;0;False;1;Header(EXTERIOR WALLS  DETAILS);False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;171;7624.25,1430.129;Float;False;Property;_Transparency;Transparency;40;2;[HideInInspector];[Gamma];Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;345;7961.389,823.4713;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=BE5D722A6A3CCCA8C052B6FF215F7867ACC5D05A