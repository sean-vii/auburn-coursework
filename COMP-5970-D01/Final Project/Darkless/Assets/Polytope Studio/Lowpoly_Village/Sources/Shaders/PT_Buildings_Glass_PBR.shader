	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float Occlusion = 1;
				float Alpha = smoothstepResult832;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				surfaceDescription.Alpha = smoothstepResult832;
...
Node;AmplifyShaderEditor.RangedFloatNode;833;-4503.05,1766.66;Float;False;Property;_Transparency;Transparency;1;2;[Gamma];[Header];Create;False;0;0;0;False;0;False;0.85;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;835;-3837.795,1322.305;Float;False;Property;_Color;Color;0;2;[HDR];[Header];Create;True;0;0;0;False;0;False;0.004227493,0.8962264,0.8136094,1;0.000303527,0.783538,0.6239606,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
